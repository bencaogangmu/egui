...
static const char* get_event_str(int type)
{
	...
	case MESSAGE_TYPE_MOUSE_SINGLE_CLICK_LEFT:
		return "MESSAGE_TYPE_MOUSE_SINGLE_CLICK_LEFT";
		break;
	case MESSAGE_TYPE_MOUSE_SINGLE_CLICK_MID:
		return "MESSAGE_TYPE_MOUSE_SINGLE_CLICK_MID";
		break;
	case MESSAGE_TYPE_MOUSE_SINGLE_CLICK_RIGHT:
		return "MESSAGE_TYPE_MOUSE_SINGLE_CLICK_RIGHT";
		break;
	case MESSAGE_TYPE_MOUSE_DOUBLE_CLICK_LEFT:
		return "MESSAGE_TYPE_MOUSE_DOUBLE_CLICK_LEFT";
		break;
	case MESSAGE_TYPE_MOUSE_DOUBLE_CLICK_MID:
		return "MESSAGE_TYPE_MOUSE_DOUBLE_CLICK_MID";
		break;
	case MESSAGE_TYPE_MOUSE_DOUBLE_CLICK_RIGHT:
		return "MESSAGE_TYPE_MOUSE_DOUBLE_CLICK_RIGHT";
		break;
	default:
		break;
	}

...
int main()
{
	...
	/* 画背景图片 */
    Desktop_im = image_view_init("/home/wang/egui/resource/icons/desktop/desktop1.bmp");
    if(Desktop_im == NULL)
    {
        application_exit();
        return -1;
	...
	icon_set_img_path(ic_desktop_ptr[0],"/home/wang/egui/resource/icons/calculator_big.bmp");
	icon_set_img_normal_path(ic_desktop_ptr[0],"/home/wang/egui/resource/icons/calculator_big.bmp");
	icon_set_img_select_path(ic_desktop_ptr[0],"/home/wang/egui/resource/icons/calculator_select_big.bmp");
	ic_desktop_ptr[0]->callback = icon_calc_callback;

	/* 第二个是资源管理器 */
	icon_set_text(ic_desktop_ptr[1],"file");
	icon_set_img_path(ic_desktop_ptr[1],"/home/wang/egui/resource/icons/file_browser_big.bmp");
	icon_set_img_normal_path(ic_desktop_ptr[1],"/home/wang/egui/resource/icons/file_browser_big.bmp");
	icon_set_img_select_path(ic_desktop_ptr[1],"/home/wang/egui/resource/icons/file_browser_select_big.bmp");
	ic_desktop_ptr[1]->callback = icon_file_callback;	
    
    /* 第三个是game */
	icon_set_text(ic_desktop_ptr[2],"game");
	icon_set_img_path(ic_desktop_ptr[2],"/home/wang/egui/resource/icons/game_big.bmp");
	icon_set_img_normal_path(ic_desktop_ptr[2],"/home/wang/egui/resource/icons/game_big.bmp");
	icon_set_img_select_path(ic_desktop_ptr[2],"/home/wang/egui/resource/icons/game_select_big.bmp");
	ic_desktop_ptr[2]->callback = icon_game_callback;    
    
    /* 第四个是single */
	icon_set_text(ic_desktop_ptr[3],"sin");
	icon_set_img_path(ic_desktop_ptr[3],"/home/wang/egui/resource/icons/single_window_big.bmp");
	icon_set_img_normal_path(ic_desktop_ptr[3],"/home/wang/egui/resource/icons/single_window_big.bmp");
	icon_set_img_select_path(ic_desktop_ptr[3],"/home/wang/egui/resource/icons/single_window_select_big.bmp");
	ic_desktop_ptr[3]->callback = icon_sin_callback;  
	  
    /* 第五个是pop */
	icon_set_text(ic_desktop_ptr[4],"pop");
	icon_set_img_path(ic_desktop_ptr[4],"/home/wang/egui/resource/icons/pop_up_window_big.bmp");
	icon_set_img_normal_path(ic_desktop_ptr[4],"/home/wang/egui/resource/icons/pop_up_window_big.bmp");
	icon_set_img_select_path(ic_desktop_ptr[4],"/home/wang/egui/resource/icons/pop_up_window_select_big.bmp");
	ic_desktop_ptr[4]->callback = icon_pop_callback;

	/* 第六个是 end */
	icon_set_text(ic_desktop_ptr[5],"end");
	icon_set_img_path(ic_desktop_ptr[5],"/home/wang/egui/resource/icons/shutdown_big.bmp");
	icon_set_img_normal_path(ic_desktop_ptr[5],"/home/wang/egui/resource/icons/shutdown_big.bmp");
	icon_set_img_select_path(ic_desktop_ptr[5],"/home/wang/egui/resource/icons/shutdown_select_big.bmp");
